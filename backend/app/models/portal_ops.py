...
class SiteRfi(Base):
    ...
    description: Mapped[str] = mapped_column(Text, nullable=False)
    chainage: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ae_name: Mapped[str | None] = mapped_column(String(255), nullable=True, deferred=True)
    contractor_name: Mapped[str | None] = mapped_column(String(255), nullable=True, deferred=True)
    category: Mapped[str | None] = mapped_column(String(128), nullable=True, deferred=True)
    inspection_date: Mapped[date | None] = mapped_column(Date, nullable=True, deferred=True)
    photo_path: Mapped[str | None] = mapped_column(String(512), nullable=True, deferred=True)
    priority: Mapped[str] = mapped_column(String(32), default="medium", nullable=False)
