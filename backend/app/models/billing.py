...
class Invoice(Base):
    ...
    this_bill_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 2), nullable=True)
    cumulative_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 2), nullable=True)
    contract_amount_cr: Mapped[Decimal | None] = mapped_column(Numeric(18, 2), nullable=True)
    invoice_pdf_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    final_bill_pdf_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    diary_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    diary_signature: Mapped[str | None] = mapped_column(String(255), nullable=True)
    correspondence_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
